...
<body>
	...
	<div class="container body_container">
		<h1 class="text-center">Sửa Sử dụng máy</h1>
		<form:form action="${CP}/su-dung-may/sua-chua/${sua_su_dung_may.id}"
			method="post" modelAttribute="sua_su_dung_may">
			...
			<div class="form-group">
				...
				<form:select path="may" id="may" name="may" cssClass="form-control">
					<c:forEach items="${danhSachMay}" var="item">
						<form:option value="${item.maMay}"
							label="${item.maMay} - ${item.trangThai}"></form:option>
					</c:forEach>
				</form:select>
			...
			<div class="form-group">
				...
				<form:input type="time" value="${sua_su_dung_may.gioBatDauSuDung }"
					step="1" cssClass="form-control" id="gioBatDauSuDung"
					name="gioBatDauSuDung" path="gioBatDauSuDung"></form:input>
			...
			<button type="submit"
				...
				<i class="fa-solid fa-plus"></i>Sửa Sử dụng máy
			</button>
			<button type="button" class="btn btn-primary text-white"
				onclick="window.location.href='${CP}/su-dung-may/danh-sach-su-dung-may';">
