...
<body>
	...
	<div class="container body_container">
		<h1 class="text-center">Sửa Dịch Vụ</h1>
		<form:form action="${CP}/dich-vu/sua-chua/${sua_dich_vu.maDV }" method="post"
			modelAttribute="sua_dich_vu">
			...
			<button type="submit"
				...
				<i class="fa-solid fa-plus"></i>Sửa Dịch Vụ
			</button>
			<button type="button" class="btn btn-primary text-white"
				onclick="window.location.href='${CP}/dich-vu/danh-sach-dich-vu';">
