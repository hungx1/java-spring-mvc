...
<body>
	...
	<div class="container body_container">
		<h1 class="text-center">Sửa Máy</h1>
		<form:form action="${CP}/may/sua-chua/${sua_may.maMay }" method="post"
			modelAttribute="sua_may">
			...
			<button type="submit"
				...
				<i class="fa-solid fa-plus"></i>Sửa Máy
			</button>
			<button type="button" class="btn btn-primary text-white"
				onclick="window.location.href='${CP}/may/danh-sach-may';">
